...
insert into WCLocation values ( 'B1층 정면50m 고객안내센터 앞', '명덕(2.28민주운동기념회관)', 1, 1, 'D', '대구도시철도', 1, 35.85782162, 128.5910961);
...
insert into WCLocation values ( '1번 엘레베이터 앞', '용산(서부법원·검찰청입구)', 2, 2, 'D', '대구도시철도', 2, 35.84906031, 128.5288041);
...
insert into WCLocation values ( '2층 대합실', '명덕(2.28민주운동기념회관)', 3, 2, 'U', '대구도시철도', 2, 35.85782162, 128.5910961);
